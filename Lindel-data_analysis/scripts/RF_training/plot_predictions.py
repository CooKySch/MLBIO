...
def main():
    ...
    sns.histplot(mses, bins=40, color='#F88379', label='Random Forest', alpha=0.8, edgecolor=None)
    sns.histplot(mses_lindel, bins=40, color='#ADD8E6', label='Lindel', alpha=0.8, edgecolor=None)
