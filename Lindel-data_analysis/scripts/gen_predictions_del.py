...
def main():
    ...
    parser.add_argument('-m', '--model', dest='model', default= "data/L1_del.h5", type=str, help="File path of the model")
    parser.add_argument('-o, --output_file_predictions', dest='output_file', default="data/predictions_del",type=str, help="File path of the output file")
